...
class Tracking {
	...
	public function add_script(): void {
		...
		const MIXPANEL_CUSTOM_LIB_URL = "https://mixpanel-tracking-proxy-prod.public-default.live2-k8s-cph3.ingress.k8s.g1i.one/lib.min.js";
		...
		mixpanel.init( <?php echo $this->token; ?>, {
			api_host: "https://mixpanel-tracking-proxy-prod.public-default.live2-k8s-cph3.ingress.k8s.g1i.one",
			id: false,
